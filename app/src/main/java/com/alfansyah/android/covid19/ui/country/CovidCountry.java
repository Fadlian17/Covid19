...
public class CovidCountry implements Parcelable {
    ...
    public CovidCountry(String mCovidCountry, String mCases, String mTodayCases, String mDeaths, String mTodayDeaths, String mRecovered, String mCritical, String mFlags) {
